...
class DatabaseManager:
    ...
    def get_user_application(self, user_id):
        self.cursor.execute("SELECT id, status, created_at FROM applications WHERE user_id = ? ORDER BY created_at DESC LIMIT 1", (user_id,))
        return self.cursor.fetchone()
