...
@dp.callback_query(F.data.startswith("ticket_") and ~F.data.startswith("ticket_reply_") and ~F.data.startswith("ticket_archive_") and ~F.data.startswith("ticket_close_"))
...
async def ticket_archive(call: CallbackQuery):
    ...
    await call.answer("Тикет скопирован в архив")
